/**
 *  \file  cr_qk21.c
 *  \brief  Extension of integration/qk21.c from GSL source code, to accomodate complex-valued functions with
...
void
cr_gsl_integration_qk21(const cr_function *f, double a, double b,
                        double complex *result, double complex *abserr,
                        double complex *resabs, double complex *resasc)
{
  double complex fv1[11], fv2[11];
  cr_gsl_integration_qk(11, xgk, wg, wgk, fv1, fv2, f, a, b, result, abserr, resabs, resasc);
}
