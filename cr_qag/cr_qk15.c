/**
 *  \file  cr_qk15.c
 *  \brief  Extension of integration/qk15.c from GSL source code, to accomodate complex-valued functions with
...
static const double xgk[8] =                    /**< \brief abscissae of the 15-point kronrod rule. */
{
...
void
cr_gsl_integration_qk15(const cr_function *f, double a, double b,
                        double complex *result, double complex *abserr,
                        double complex *resabs, double complex *resasc)
{
  double complex fv1[8], fv2[8];
  cr_gsl_integration_qk(8, xgk, wg, wgk, fv1, fv2, f, a, b, result, abserr, resabs, resasc);
}
